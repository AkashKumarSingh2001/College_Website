<?php
    ...
    {                    
        ...
        $email = $_POST['email'];
        $mobile = $_POST['mobile'];
        $sql = "INSERT INTO `authorform`(`paperid`,`papertitle`,`firstname`, `middlename`, `lastname`, `affiliation`, `authortype`, `amounttype`, `amount`, `paymenttype`,`date`, `country`, `state`, `utr`, `email`, `mobile`) VALUES ('$paperid','$papertitle','$fname','$mname','$lname','$affiliation','$authortype','$amounttype','$amount','$payment','$datetime','$country','$state','$UTR','$email','$mobile');";
        // echo $sql;
...
<body>
	...
	<section class="container-fluid header">
		<div class="row">
			<div class="col-md-2 offset-md-2 text-center pt-3 pb-4">
				<img src="https://sdbc.ac.in/icmmt/images/bansal.png" class="img-responsive" alt="logo" width="250" height="100">
			</div>
			...
			<div class="col-md-2 text-center pt-3 pb-4">
				<img src="https://sdbc.ac.in/icmmt/images/ICMMT logo.jpg" class="img-responsive" alt="logo" width="130" height="100">
			</div>
		</div>	
	</section>
	<!-- Header Section End -->
	...
	<div class="container">
				...
				<div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav">
                        <li class="nav-item p-2 ">
                            <a class="nav-link" href="https://sdbc.ac.in/icmmt/">Home</a>
                        </li>
                        <li class="nav-item p-2">
                            <a class="nav-link" href="/icmmt/pages/callForPaper.html">Call for papers</a>
                        </li>
                        <li class="nav-item p-2">
                            <a class="nav-link" href="/icmmt/pages/committee.html">Committee</a>
                        </li>
                        <li class="nav-item p-2">
                            <a class="nav-link" href="/icmmt/pages/keyNote.html">Keynote Speakers</a>
                        </li>
                        <li class="nav-item p-2">
                            <a class="nav-link" href="/icmmt/pages/registrationFee.html">Registration Fee</a>
                        </li>
                        <li class="nav-item p-2">
                            <a class="nav-link" href="/icmmt/pages/publication.html">Publication</a>
                        </li>
                        <li class="nav-item p-2">
                            <a class="nav-link" href="/icmmt/pages/organizer.html">Organizers</a>
                        </li>
                        <li class="nav-item p-2">
                            <a class="nav-link" href="/icmmt/pages/contacts.html">Contact Us</a>
                        </li>
                    </ul>
				</div>
			</nav>
        ...
        <section class="container mt-3 mb-3 pt-4 pb-4"  style="background-color:white; ">
            <div>
                <h4 class="style1"><font color="#40d0c6" font-weight:bold>Author Information</font></h4>
                <h4>&nbsp;</h4>
            </div>
			<form method="post">
                <div class="form-group"><label for="text">Paper ID</label>
                    <input class="form-control" type="number" name="paperid" placeholder="Paper ID" required>
                </div>
                <div class="form-group"><label for="text">Paper Title</label>
                    <textarea class="form-control" type="text" name="papertitle" placeholder="Paper Title" required></textarea>
                </div>
				...
				<div class="row justify-content-center">
					<button class="btn" type="submit" style="background-color: #40d0c6; color: white; font-weight: bold;" name = "submit">SUBMIT</button>
				</div>
			</form>	
            <h6>&nbsp;</h6>
            <div class="row justify-content-center">
                <a href="/icmmt/pages/ptype.html" style="text-decoration: none; font-weight: bolder;"> Go Back</a>
            </div>
        </section>
