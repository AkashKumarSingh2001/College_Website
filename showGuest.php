   ...
   <!-- Site Logo -->
	...
	<div class="container-fluid">
        ...
        <div class="row p-3 justify-content-end" style="position:relative;">
            <button type="button" class="btn btn-primary" onclick="location.href='showGuest.php'" style="background-color:#40d0c6; border:none; position:absolute; left:1.5%;">Refresh</button>
            <br>
