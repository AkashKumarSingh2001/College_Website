<?php
    ...
    $email = $_POST['email'];
    $mobile = $_POST['mobile'];
    $sql = "INSERT INTO `icmmt`.`guest`(`FName`, `MName`, `LName`, `Affiliation`, `Designation`, `AmountType`, `Amount`, `Payment`,`Datetime`, `Country`, `State`, `UTR`, `Email`, `Mobile`) VALUES ('$fname','$mname','$lname','$affiliation','$designation','$amounttype','$amount','$payment','$datetime','$country','$state','$UTR','$email','$mobile')";
    // echo $sql;
