...
<body>
	...
	<div class="container">
			...
			<nav class="navbar navbar-expand-lg">
				...
				<div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item p-2">
                            <a class="nav-link" href="registrationFee.html">Registration Fee</a>
                        </li>
                        <li class="nav-item p-2">
        ...
        <section class="container"  style="background-color:white; height: 400px;">
			...
			<div>
				<ul>
				<li><h5><a href="https://sdbc.ac.in/icmmt/pages/showAuthor.php" target="_blank" style="text-decoration: none; color: red;">Check Author Details</a></h5></li>
				<li><h5><a href="https://sdbc.ac.in/icmmt/pages/showGuest.php" target="_blank" style="text-decoration: none; color: red;">Check Guest Details</a></h5></li>
			</ul>
			</div>
            <h6>&nbsp;</h6>
